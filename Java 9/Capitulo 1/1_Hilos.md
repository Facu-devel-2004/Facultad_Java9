...
## Extend Thread
Hacerlo hara que se bloquee para que ontra clase no la pueda heredar, no permite herencia multiple. Mi clase se convierte en un hilo. Debo crear una nueva instancia por cada hilo.

## Implement Runnable
Me dejara extenderla a otra clase y separar la tarea del hilo en si. Defino una tarea independiente. Puedo crear una sola instancia de la tarea y pasarsela a hilos diferentes.